 ...
 */
@TargetApi(21)
public class TransportControlsProxyImplL implements IMediaControllerProxy.TransportControlsProxy {
    final MediaController.TransportControls mControls;

    public TransportControlsProxyImplL(MediaController.TransportControls mControls) {
    ...
    public void setRating(RatingCompat rating) {
        mControls.setRating((Rating) rating.getRating());
    }
