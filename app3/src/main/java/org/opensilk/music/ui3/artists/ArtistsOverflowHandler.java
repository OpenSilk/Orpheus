 ...
 */
@ScreenScope
public class ArtistsOverflowHandler implements OverflowClickListener {
...
//            R.menu.popup_delete,
    ...
    public boolean onItemClicked(Context context, OverflowAction action, Bundleable item) {
        final Uri uri = LibraryUris.artistTracks(libraryConfig.authority,
                libraryInfo.libraryId, item.getIdentity());
        final String sortOrder = appPreferences.getString(appPreferences.makePluginPrefKey(libraryConfig,
