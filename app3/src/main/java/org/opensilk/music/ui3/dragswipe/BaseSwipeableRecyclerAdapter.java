 ...
 */
public abstract class BaseSwipeableRecyclerAdapter<T> extends SwipeableRecyclerAdapter<T, BaseSwipeableRecyclerAdapter.ViewHolder> {
    ...
    public BaseSwipeableRecyclerAdapter() {
        super();
    }
    ...
    public static class ViewHolder extends SwipeableRecyclerAdapter.ViewHolder {
...
//            if (dragHandle.getVisibility() != View.GONE) {
//                dragHandle.setVisibility(View.GONE);
//            }
