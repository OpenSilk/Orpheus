 ...
 */
@ScreenScope
public class TracksDragSwipePresenter extends ViewPresenter<TracksDragSwipeRecyclerView> implements
        RxLoader.ContentChangedListener,
        HasOptionsMenu {
    ...
    protected final TrackItemClickListener itemClickListener;
    protected final OverflowClickListener overflowClickListener;
    protected final ActionBarMenuConfig menuConfig;
    protected final TrackDragSwipeEventListener dragSwipeEventListener;

    protected Subscription subscription;
    protected boolean adapterIsDirty;

    @Inject
    public TracksDragSwipePresenter(
            AppPreferences preferences,
            ArtworkRequestManager requestor,
            BundleableLoader loader,
            TracksDragSwipePresenterConfig config
    ) {
        ...
        this.dragSwipeEventListener = config.dragSwipeEventListener;
    }
