...
public class HelpersTest {
    ...
    public void testDurationParcer() {
        ...
        assertThat(Helpers.parseDuration(duration)).isEqualTo(25);
        duration = "0:05:53.645";
        assertThat(Helpers.parseDuration(duration)).isEqualTo(353);
        ...
        assertThat(Helpers.parseDuration(duration)).isEqualTo(7553);
    }
}
