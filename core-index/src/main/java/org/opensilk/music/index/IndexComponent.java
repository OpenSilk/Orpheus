...
public interface IndexComponent extends AppContextComponent {
    Func1<AppContextComponent, IndexComponent> FACTORY = new Func1<AppContextComponent, IndexComponent>() {
        @Override
        public IndexComponent call(AppContextComponent appContextComponent) {
