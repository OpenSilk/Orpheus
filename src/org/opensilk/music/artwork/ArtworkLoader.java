 ...
 * thread as well.
 *
 * Modifed from Volleys ImageLoader to take artist/album name combo, and initiate an ArtworkRequest
 * that wraps and ImageRequest handling the multiple network calls needed to get the image
 */
