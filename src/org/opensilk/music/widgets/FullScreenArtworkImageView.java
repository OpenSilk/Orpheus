 ...
 */
public class FullScreenArtworkImageView extends ArtworkImageView {

    public FullScreenArtworkImageView(Context context) {
        this(context, null);
    }

    public FullScreenArtworkImageView(Context context, AttributeSet attrs) {
