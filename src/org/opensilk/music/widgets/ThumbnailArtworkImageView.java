 ...
 */
public class ThumbnailArtworkImageView extends ArtworkImageView {

    public ThumbnailArtworkImageView(Context context) {
        this(context, null);
    }

    public ThumbnailArtworkImageView(Context context, AttributeSet attrs) {
