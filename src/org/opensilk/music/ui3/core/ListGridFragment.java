...
package org.opensilk.music.ui3.core;
 ...
 */
public abstract class ListGridFragment extends ScopedDaggerFragment {
    static final int INTERNAL_EMPTY_ID = R.id.lg__empty_view;
    static final int INTERNAL_PROGRESS_CONTAINER_ID = R.id.lg__progress_container;
    static final int INTERNAL_LIST_CONTAINER_ID = R.id.lg__list_container;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_listgrid, container, false);
