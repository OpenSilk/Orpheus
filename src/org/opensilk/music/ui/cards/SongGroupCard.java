    ...
    protected void onInnerViewSetup() {
        ...
        if (mData.albumIds.length > 0){
            ...
            if (mArtwork4 != null && mArtwork3 != null && mArtwork2 != null) {
                mArtLoaderTask = new MultipleArtworkLoaderTask(getContext(), mData.albumIds, mArtwork, mArtwork2, mArtwork3, mArtwork4).execute();
            } else if (mArtwork2 != null) {
                mArtLoaderTask = new MultipleArtworkLoaderTask(getContext(), mData.albumIds, mArtwork, mArtwork2).execute();
            } else {
                mArtLoaderTask = new MultipleArtworkLoaderTask(getContext(), mData.albumIds, mArtwork).execute();
            }
        }
    }
