...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setMinimumHeight(getResources().getDimensionPixelSize(R.dimen.abc_action_bar_default_height_material));
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (i == currentPosition) {
                tabTitleView.setTextColor(mSelectedTextColor);
            }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            View selectedTitle = mTabStrip.getChildAt(position);
            TextView titleView;
            if (TextView.class.isInstance(selectedTitle)) {
                titleView = (TextView) selectedTitle;
            } else {
                titleView = (TextView) selectedTitle.findViewWithTag("title");
            }
            titleView.setTextColor(mSelectedTextColor);

            // Un highlight the previous item
            selectedTitle = mTabStrip.getChildAt(mPreviousPosition);
            if (TextView.class.isInstance(selectedTitle)) {
                titleView = (TextView) selectedTitle;
            } else {
                titleView = (TextView) selectedTitle.findViewWithTag("title");
            }
            titleView.setTextColor(mUnselectedTextColor);
