 ...
 */
public class PlaylistIntegerResult implements PlaylistOperationListener<Integer> {

    final ResultReceiver resultReceiver;

    public PlaylistIntegerResult(ResultReceiver resultReceiver) {
    ...
    public void onSuccess(Integer val) {
        resultReceiver.send(PlaylistExtras.RESULT_SUCCESS, PlaylistExtras.b().putInt(val).get());
    }
